...
Field of view is the maximum visual angle that can be seen instantaneously on a display. It is measured in degrees and can vary with the user's position and orientation relative to the screen.
