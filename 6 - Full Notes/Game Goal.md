...
A game goal is a desired result or condition that a player works toward. A game may contain many nested goals, and a goal can organize activity even when it is difficult or impossible to complete.
